...
The main section of this script to adjust are the two arrays one for ports and the other is clients, at top of script. If you want to add more, just follow the same format with ports and clients
